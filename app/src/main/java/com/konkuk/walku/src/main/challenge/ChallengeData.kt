...
data class ChallengeData(var num:Int, var challengetype:String ,var day:String, var context:String,var achivementamount:Int, var achivement:Int, var starttime:String, var remaintime:String,var timer: Timer){
